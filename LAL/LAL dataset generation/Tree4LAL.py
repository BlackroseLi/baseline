...
if __name__ == "__main__":
    ...
    data =DatasetSimulated(100, 2)
    lalModels=[]
    tree = Tree4LAL('random', data, lalModels, 'error')
    tree.generateTree(4)
    data_for_lal, labels_for_lal = tree.getLALdatapoints(5)
    print(data_for_lal.shape)
    print(labels_for_lal.shape)
    print(data_for_lal)
    print(labels_for_lal)